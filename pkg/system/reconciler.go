...
type Reconciler struct {
	...
	GCPContainerCreds   *corev1.Secret
...
func NewReconciler(
	...
	r := &Reconciler{
		...
		GCPContainerCreds:   util.KubeObject(bundle.File_deploy_internal_secret_empty_yaml).(*corev1.Secret),
	...
	r.GCPContainerCreds.Namespace = r.Request.Namespace
	...
	r.GCPContainerCreds.Name = r.Request.Name + "-gcp-container-creds"
...
func (r *Reconciler) CheckAll() {
	...
	util.KubeCheckOptional(r.GCPContainerCreds)
